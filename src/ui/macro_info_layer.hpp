...
class MacroInfoLayer : public geode::Popup<> {
    ...
    bool setup() override {
        ...
        std::string frameFixesCount = std::to_string(static_cast<int>(macro.frameFixes.size()));
        ...
        addRow("Frame Fixes:", frameFixesCount, startY - rowH * 4);
